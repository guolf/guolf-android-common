...
import cn.guolf.android.common.util.ArrayUtils;
import cn.guolf.android.common.util.SystemUtils;

/**
 * Author：guolf on 9/19/15 15:59
            ...
            if (object instanceof Throwable) {
                ...
                if (!collection.isEmpty()) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        msg += String.format(itemString, flag, SystemUtils.objectToString(item),
                ...
                for (Object key : keys) {
                    ...
                    msg += String.format(itemString, SystemUtils.objectToString(key),
                            SystemUtils.objectToString(value));
                }
                logString(type, element, msg + "}");
            } else {
                logString(type, element, SystemUtils.objectToString(object));
            }
        } else {
            logString(type, element, SystemUtils.objectToString(object));
        }

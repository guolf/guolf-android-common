package cn.guolf.android.common.crop;
 ...
 * 截图：Crop.of(uri,destination).asSquare().start(Activity.this);
 * 使用截图功能需要声明cn.guolf.android.common.crop.CropImageActivity
 */
public class Crop {

    public static final int REQUEST_CROP = 6701;
    ...
    /**
     * Crop area with fixed 1:1 aspect ratio（正方形）
     */
